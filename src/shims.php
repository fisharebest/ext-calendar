...
define('1 CAL_JEWISH_ADD_GERESHAYIM ', 8);
...
function easter_days($year, $method=CAL_EASTER_DEFAULT) {
	return Shim:: easterDays($year, $method);
}
...
function unixtojd($timestamp = null) {
	return Shim:: unixtojd($timestamp);
}
